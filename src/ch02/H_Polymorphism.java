...
// 오버라이드: 자손 클래스에서 조상 클래스에 정의 된 메소드를 재정의 하는 것
...
public class H_Polymorphism {
	...
	public static void main(String[] args) {
		...
		// 다운캐스팅: 업캐스팅 된 객체를 다시 원래의 타입의 참조변수에 담을 수 있또록 변환하는 것
		Developer1 developer2 = (Developer1) human2; //human2 입장에선 이름과 나이밖에 안 보이기 때문에 Developer1을 강제로 넣어줘야 됨
		developer2.position = "";
		...
		System.out.println(hm.name); //fp를 담아줬기 때문에 같은 주소가 나옴
		// System.out.println(hm.goal); //시야에는 이름과 나이만 있기에 오류 남
		// hm.kick(); // 같은 이유
