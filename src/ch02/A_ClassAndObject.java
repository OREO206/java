...
class ExampleClass1 {
	...
	void method3 (int arg1) {
		// void에서의 return은 강제로 메서드를 종료하기 위해 사용(break같은 느낌)
		return;
	}
	// 매개변수: x, 반환값 : x
	void method4 () {
...
//		method2();
	...
	ExampleClass1(int attribute1, double arg2) {
		...
		this.attribute1 = attribute1; // this는 클래스라인에서 선언 돼 있는 것으로 인식
...
// 이름		(name - String)
// 포지션		(position - String)
// 생년월일	(birth - String) // int는 01같은 숫자가 불가능하다.
// 키		(height - double)
// 몸무게		(weight - double)
// 국적		(country - String)
// 주발		(mainFoot - String)
...
public class A_ClassAndObject {
	...
	public static void main(String[] args) {
		...
		// 인스턴스: 특정 클래스로 정의 된 것을 실체화 한 것 (객체)
		// 클래스명 참조변수명 = new 클래스명();
		ExampleClass1 instance1 = new ExampleClass1(0, 0);
		ExampleClass1 instance2 = new ExampleClass1(0, 0); // 여기가 외부에서 불러오는 값 지정 하는 곳
