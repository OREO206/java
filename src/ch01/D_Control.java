...
public class D_Control {
	...
	public static void main(String[] args) {
		...
		// age는 17보다 크거나 같으면서 19보다 작거나 같아야한다. - 2개의 조건 모두 만족 and
		// age >= 17 && age <= 19
		
		// age는 17보다 크거나 같거나 19보다 작거나 같아야한다. - 둘 중 하나만 만족해도 ok or
		// age >= 17 || age <= 19
		...
		// 1. else문은 반드식 if문 이후에 와야 함 (else 단독으로 사용이 불가능)
...
//				}
			...
			// for (조건에사용할변수초기화; 조건; 조건에사용할변수증감) { 반복 할 코드 }
...
//			}
			...
			// while: 반복할 횟수가 정해져 있지 않을 때 사용하는 반복문
