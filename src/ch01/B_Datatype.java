...
public class B_Datatype {
	...
	public static void main(String[] args) {
		...
		int int1 = 214_748_3647;
		// int int2 = 214_748_3648;
		
		// long: 8byte(64bit)의 크기를 가지는 정수형 데이터 타입
		long long1 = 214_748_3648L;
...
//		System.out.println(number2);
		...
		// 문자열을 다루는데 유용한 여러가지 기능을 제공해주고 있음0
		...
		// compareToIgnoreCase(문자열): 대소문자 구분 없이 사전순으로 비교
		...
		// 5. 문자열 찾기
		// indexOf(문자열): 찾고자하는 문자열의 처음찾은 위치의 인덱스 번호를 반환
